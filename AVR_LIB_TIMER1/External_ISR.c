 ...
 * */
void EXTERNAL_Interrupt_Configure(u8 INT_Number , u8 INT_Mode,u8 Input_Mode)
{
	switch(INT_Number)
	{
	case INTRRUPT_0:
 ...
 * */
void EXTERNAL_Interrupt_Enable (u8 INT_Number )
{
	switch (INT_Number)
	{
	case INTRRUPT_0:
 ...
 * The argument takes the interrupt number INTRRUPT_0,INTRRUPT_1,INTRRUPT_2
 * */
void EXTERNAL_Interrupt_Disable (u8 INT_Number )
{
	switch (INT_Number)
	{
	case INTRRUPT_0:
