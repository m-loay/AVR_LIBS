...
/*PORTB pins B0 to B7*/
#define 	PIN0_INIT_DIR_VALUE				OUTPUT
#define 	PIN1_INIT_DIR_VALUE				OUTPUT
#define 	PIN2_INIT_DIR_VALUE				OUTPUT
#define 	PIN3_INIT_DIR_VALUE				OUTPUT
#define 	PIN4_INIT_DIR_VALUE				OUTPUT
#define 	PIN5_INIT_DIR_VALUE				OUTPUT
#define 	PIN6_INIT_DIR_VALUE				OUTPUT
#define 	PIN7_INIT_DIR_VALUE				OUTPUT

/*PORTC pins C0 to C7*/
#define 	PIN8_INIT_DIR_VALUE				INPUT
#define 	PIN9_INIT_DIR_VALUE				INPUT
#define 	PIN10_INIT_DIR_VALUE			INPUT
#define 	PIN11_INIT_DIR_VALUE			INPUT
#define 	PIN12_INIT_DIR_VALUE			INPUT
#define 	PIN13_INIT_DIR_VALUE			INPUT
#define 	PIN14_INIT_DIR_VALUE			INPUT
#define 	PIN15_INIT_DIR_VALUE			INPUT
...
/*PORTA pins A0 to A7*/
#define 	PIN24_INIT_DIR_VALUE			INPUT
#define 	PIN25_INIT_DIR_VALUE			INPUT
#define 	PIN26_INIT_DIR_VALUE			INPUT
#define 	PIN27_INIT_DIR_VALUE			INPUT
#define 	PIN28_INIT_DIR_VALUE			INPUT
#define 	PIN29_INIT_DIR_VALUE			INPUT
#define 	PIN30_INIT_DIR_VALUE			INPUT
#define 	PIN31_INIT_DIR_VALUE			INPUT
