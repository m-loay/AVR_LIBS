...
/*PORTB pins B0 to B7*/
#define 	PIN0_INIT_DIR_VALUE				INPUT //B0
#define 	PIN1_INIT_DIR_VALUE				INPUT  //B1
#define 	PIN2_INIT_DIR_VALUE				INPUT  //B2
#define 	PIN3_INIT_DIR_VALUE				INPUT  //B3
#define 	PIN4_INIT_DIR_VALUE				OUTPUT  //B4
#define 	PIN5_INIT_DIR_VALUE				OUTPUT  //B5
#define 	PIN6_INIT_DIR_VALUE				OUTPUT  //B6
#define 	PIN7_INIT_DIR_VALUE				OUTPUT  //B7

/*PORTD pins C0 to C7*/
#define 	PIN8_INIT_DIR_VALUE				INPUT  //C0
#define 	PIN9_INIT_DIR_VALUE				INPUT  //C1
#define 	PIN10_INIT_DIR_VALUE			INPUT  //C2
#define 	PIN11_INIT_DIR_VALUE			INPUT  //C3
#define 	PIN12_INIT_DIR_VALUE			INPUT  //C4
#define 	PIN13_INIT_DIR_VALUE			INPUT  //C5
#define 	PIN14_INIT_DIR_VALUE			OUTPUT  //C6
#define 	PIN15_INIT_DIR_VALUE			OUTPUT  //C7

/*PORTB pins D0 to D7*/
#define 	PIN16_INIT_DIR_VALUE			INPUT  //D0
...
/*PORTB pins A0 to A7*/
#define 	PIN24_INIT_DIR_VALUE			INPUT  //A0
#define 	PIN25_INIT_DIR_VALUE			INPUT  //A1
#define 	PIN26_INIT_DIR_VALUE			OUTPUT  //A2
#define 	PIN27_INIT_DIR_VALUE			OUTPUT  //A3
#define 	PIN28_INIT_DIR_VALUE			OUTPUT  //A4
